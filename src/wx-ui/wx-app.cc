...
void Frame::OnCommand(wxCommandEvent &event) { wx_handle_command(this, event.GetId(), event.IsChecked()); }
...
wxMenu *Frame::GetMenu() { return menu; }
...
CExitThread::CExitThread(Frame *frame) { this->frame = frame; }
