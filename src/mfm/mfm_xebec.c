...
static void xebec_callback(void *p) {
        ...
        case CMD_DTC_GET_DRIVE_PARAMS:
                ...
                case STATE_START_COMMAND:
                        ...
                        pclog("Get drive params %02x %02x %02x %i\n", xebec->data[0], xebec->data[1], xebec->data[2],
                              drive->hdd_file.tracks);
                        break;
        ...
        default:
                fatal("Unknown Xebec command - %02x %02x %02x %02x %02x %02x\n", xebec->command[0], xebec->command[1],
                      xebec->command[2], xebec->command[3], xebec->command[4], xebec->command[5]);
        }
}
...
static int xebec_available() { return rom_present("ibm_xebec_62x0822_1985.bin"); }
...
static int dtc_5150x_available() { return rom_present("dtc_cxd21a.bin"); }

device_t dtc_5150x_device = {"DTC 5150X", 0, dtc_5150x_init, xebec_close, dtc_5150x_available, NULL, NULL, NULL, NULL};
