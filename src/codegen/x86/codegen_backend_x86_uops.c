...
void codegen_direct_read_pointer(codeblock_t *block, int host_reg, void *p) { codegen_direct_read_32(block, host_reg, p); }
...
void codegen_direct_write_ptr(codeblock_t *block, void *p, int host_reg) { host_x86_MOV32_ABS_REG(block, p, host_reg); }
