...
static int bass_attenuation[0x10] = {(int)(1.995 * 16384), /*12 dB - filter output is at +6 dB so we use 6 dB here*/
                                     (int)(1.995 * 16384), (int)(1.995 * 16384), (int)(1.413 * 16384), /*9 dB*/
                                     (int)(1 * 16384),                                                 /*6 dB*/
                                     ...
                                     (int)(2.819 * 16384), (int)(2.819 * 16384), (int)(2.819 * 16384), (int)(2.819 * 16384)};
...
static int treble_attenuation[0x10] = {(int)(1.995 * 16384), /*12 dB - filter output is at +6 dB so we use 6 dB here*/
                                       (int)(1.995 * 16384), (int)(1.995 * 16384), (int)(1.413 * 16384), /*9 dB*/
                                       (int)(1 * 16384),                                                 /*6 dB*/
                                       (int)(0.708 * 16384),                                             /*3 dB*/
                                       (int)(0 * 16384),                                                 /*0 dB*/
                                       ...
                                       (int)(1.413 * 16384),                                             /*9 dB*/
                                       (int)(1.995 * 16384),                                             /*12 dB*/
                                       (int)(1.995 * 16384), (int)(1.995 * 16384), (int)(1.995 * 16384),
...
void adgold_getsamp_dma(adgold_t *adgold, int channel) {
        ...
        if ((adgold->adgold_mma_regs[channel][0xc] & 0x60) &&
            (((adgold->adgold_mma_fifo_end[channel] - adgold->adgold_mma_fifo_start[channel]) & 255) >= 127))
                return;
        ...
        if (((adgold->adgold_mma_fifo_end[channel] - adgold->adgold_mma_fifo_start[channel]) & 255) >=
            adgold->adgold_mma_intpos[channel]) {
        ...
        case 5:
                ...
                case 0x9:
                        ...
                        if ((val & 0x01)) /*Start playback*/
                        {
                                ...
                                //                                (adgold->adgold_mma_fifo_end[0] -
                                //                                adgold->adgold_mma_fifo_start[0]) & 255,
                                //                                adgold->adgold_mma_fifo_end[0],
                                //                                adgold->adgold_mma_fifo_start[0],
                                //                                adgold->adgold_mma_regs[0][0xc]);
                                if (adgold->adgold_mma_regs[0][0xc] & 1) {
                                        if (adgold->adgold_mma_regs[0][0xc] & 0x80) {
                                                //                                                pclog("adgold start interleaved
                                                //                                                %i %i
                                                adgold->adgold_mma_enable[1] = 1;
                                                adgold->adgold_mma.voice_count[1] = adgold->adgold_mma.voice_latch[1];

                                                while (((adgold->adgold_mma_fifo_end[0] - adgold->adgold_mma_fifo_start[0]) &
                                                        255) < 128) {
                                                        adgold_getsamp_dma(adgold, 0);
                                                        adgold_getsamp_dma(adgold, 1);
                                                }
                                                if (((adgold->adgold_mma_fifo_end[0] - adgold->adgold_mma_fifo_start[0]) & 255) >=
                                                    adgold->adgold_mma_intpos[0]) {
                                                        adgold->adgold_mma_status &= ~0x01;
                                                        adgold_update_irq_status(adgold);
                                                }
                                                if (((adgold->adgold_mma_fifo_end[1] - adgold->adgold_mma_fifo_start[1]) & 255) >=
                                                    adgold->adgold_mma_intpos[1]) {
        ...
        case 7:
                ...
                case 0x9:
                        ...
                        if ((val & 0x01)) /*Start playback*/
                        {
                                ...
                                //                                pclog("adgold start! FIFO fill %i  %i %i %02X\n",
                                //                                (adgold->adgold_mma_fifo_end[1] -
                                //                                adgold->adgold_mma_fifo_start[1]) & 255,
                                //                                adgold->adgold_mma_fifo_end[1],
                                //                                adgold->adgold_mma_fifo_start[1],
                                //                                adgold->adgold_mma_regs[1][0xc]);
                                if (adgold->adgold_mma_regs[1][0xc] & 1) {
                                        while (((adgold->adgold_mma_fifo_end[1] - adgold->adgold_mma_fifo_start[1]) & 255) <
                                               128) {
                                                adgold_getsamp_dma(adgold, 1);
                                        }
                                }
...
void *adgold_init() {
        ...
        out = 65536.0; /*Main volume control ranges from +6 dB to -64 dB in 2 dB steps, then remaining settings are -80 dB
                          (effectively 0)*/
        for (c = 0x3f; c >= 0x1c; c--) {
...
static device_config_t adgold_config[] = {
        {.name = "surround", .description = "Surround module", .type = CONFIG_BINARY, .default_int = 1},
        {.name = "opl_emu",
         .description = "OPL emulator",
         .type = CONFIG_SELECTION,
         .selection =
                 {
                         {.description = "DBOPL", .value = OPL_DBOPL},
                         {.description = "NukedOPL", .value = OPL_NUKED},
                 },
         .default_int = OPL_DBOPL},
        {.type = -1}};

device_t adgold_device = {"AdLib Gold", 0, adgold_init, adgold_close, NULL, NULL, NULL, NULL, adgold_config};
